...
export class AdvertisementDialogComponent implements OnInit {
  ...
  constructor(
    ...
    this.hasPermission = data.advertisement === null || (!!data.user && data.advertisement.userId === data.user.uid);
  }
  ...
  ngOnInit(): void {
    this.form = this.fb.group({
      ...
      title: [
        { value: this.data.advertisement?.title ?? null, disabled: !this.hasPermission },
        Validators.required,
      ],
      description: [
        {
      ...
      image: [
        { value: this.data.advertisement?.image ?? null, disabled: !this.hasPermission },
      ],
      userId: [
